...
public class Sparepart implements java.io.Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((purchaseDt == null) ? 0 : purchaseDt.hashCode());
		result = prime * result
				+ ((sparepartNm == null) ? 0 : sparepartNm.hashCode());
	...
	public String toString() {
		return "Sparepart [sparepartNo=" + sparepartNo + ", sparepartNm="
				+ sparepartNm + ", modelNo=" + modelNo + ", purchaseDt="
				+ purchaseDt + ", price=" + price + ", jobsheetSparepart="
				+ jobsheetSparepart + "]";
	}
