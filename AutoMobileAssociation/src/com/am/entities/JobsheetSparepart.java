...
public class JobsheetSparepart implements java.io.Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((sparepartSaleDt == null) ? 0 : sparepartSaleDt.hashCode());
		return result;
	}
	...
	public String toString() {
		return "JobsheetSparepart [sparepartNo=" + sparepartNo + ", jobsheet="
				+ jobsheet + ", sparepart=" + sparepart + ", sparepartSaleDt="
				+ sparepartSaleDt + ", amount=" + amount + "]";
	}
